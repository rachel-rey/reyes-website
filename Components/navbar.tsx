...
export default function Navbar() {
  ...
  return (
    <nav className="bg-navbar text-white shadow-md p-8">
      ...
      {/* Mobile Menu Overlay */}
      {isOpen && (
        <div className="fixed inset-0 bg-navbar bg-opacity-95 flex flex-col items-center justify-center space-y-6 text-2xl z-50">

...
export default function AboutMe() {
  return (
    <div className=" px-6 bg-fixed md:px-16 lg:px-24 py-6">
      ...
      {/* Hobbies Section */}
      <div className=" bg-[url('/Photos/rockymountainpic.JPG')] bg-cover bg-fixed bg-center"> 
      <div className="bg-transparent/60 p-8 pb-16">

        {/* Outdoors Hobby */}
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] items-center gap-8  py-4">
          <Image
        ...
        {/* Books Hobby */}
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] items-center gap-8 py-4">
          <p className="text-lg leading-relaxed max-w-lg bg-mybrown/75 p-6 rounded-lg shadow-lg">

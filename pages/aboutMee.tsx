...
export default function AboutMe() {
  return (
    <div className=" px-6 bg-fixed md:px-16 lg:px-24 py-6">
      ...
      <div className="bg-[url('/Photos/rockymountainpic.JPG')] bg-cover min-h-screen">
      <p className="text-lg">
        ...
        Reading is one of my favorite vices, and while in this day and age of technology it can be a little hard to settle, I always find myself emersed in a good bood. Currently I am reading <strong> East of Eden</strong>.
